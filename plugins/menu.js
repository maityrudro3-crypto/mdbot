...
const name = process.env.BOT_NAME || config.botName || "King Rudro";
const runtime = (secs) => {
...
*┃🌨️ ᴛɪᴍᴇ    :* ${time}
*┃🫂 ᴜsᴇʀ    :* ${userName}
*┃🕊️ ᴘᴀɪʀ   :* ${process.env.PAIR_INFO || "Use the pairing endpoint"}
*┃🎀 ᴏᴡɴᴇʀ   :* ${config.ownerName || "King Rudro"}
*┃🎐 ᴅᴇᴠᴇʟᴏᴘᴇʀ :* ${config.ownerName || "King Rudro"}
*╰═════════════════⊷*
${readMore}
*♡︎•━━━━━${name}━━━━━━•♡*
`;
      ...
      _cmd_st += `*~_Made with love by ${name} 😩🫶_~*`;
    }

    const channelJid = process.env.MENU_CHANNEL_JID || "";
