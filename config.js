...
export default {
  ...
  sudo: process.env.SUDO || process.env.OWNER_NUMBER || "",
  packname: process.env.PACKNAME || "King Rudro",
  author: process.env.AUTHOR || "King Rudro",
  botName: process.env.BOT_NAME || "King Rudro",
  ownerName: process.env.OWNER_NAME || "King Rudro",
